<div class="footer">
	<div class="footer-content clearfix">
		<div class="container">
				...
				<div class="footer-box box-address col-md-3 col-sm-12 col-xs-12">
					<div class="item">
						...
						<div class="box-address-content toggle-footer" style="">
							<b>Laptop mới  </b>
							<p><i class=""></i> Kết nối trái tim - Kết nối toàn cầu</p>
								<p>
				...
				<div class="footer-box box-social col-md-3 col-sm-12 col-xs-12">
					<div class="item">
						...
						<div class="box-address-content toggle-footer" style="">
							...
							<p><i class="fa fa-address-card" aria-hidden="true"></i> Nhân viên chăm sóc khác hàng:</p> 
							<p>
								<i class="fa fa-phone"></i>
								Mr.Hà: 096521415445
							</p>
				...
				<div class="footer-box box-letter col-md-3 col-sm-12 col-xs-12 hide">
					<div class="item">
						...
						<div class="letter-content">
							<div class="new-paper">
								<div class="input-box">
									<input name="email" id="txtNewsletter" class="input-text form-control" value="" placeholder="Your Emain Address" type="text">
								</div>
			...
			<div class="row">
			<h5 style="float: left; color: white; padding-bottom: 15px">&#169;Laptop mơi 354 Trần Hưng Đạo - TP.Nam Định</h5>
